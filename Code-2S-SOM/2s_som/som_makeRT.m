...
function [sMap bmus] = som_makeRT(D, vect, UpdateRule, varargin)
...
switch func,
 ...
 case 'batch',  [sMap bmus] = som_batchtrainOM(sMap,D,vect,UpdateRule,sTrain,'tracking',tracking,'mask',mask);
end
...
switch func,
 case 'seq',    sMap = som_seqtrain(sMap,D,sTrain,'tracking',tracking,'mask',mask);
 case 'sompak', sMap = som_sompaktrain(sMap,D,sTrain,'tracking',tracking,'mask',mask);
 case 'batch',  [sMap bmus] = som_batchtrainOM(sMap, D,'mixed1',[5 2],[4 2],sTrain,'tracking',tracking,'mask',mask);
end
